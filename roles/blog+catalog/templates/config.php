...
{
  $config['base_url'] = 'https://librivox.org/';
}
else
{
  switch (ENVIRONMENT){
    ...
    break;
    default:
      die('Application variable ENVIRONMENT not configured correctly.  Check apache config. ENVIRONMENT=' . ENVIRONMENT);
    break;
  }
...
|
*/
$config['log_threshold'] = {{ ci_log_threshold }};
